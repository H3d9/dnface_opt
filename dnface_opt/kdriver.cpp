...
bool KernelDriver::load() {
	...
	if (hDriver == INVALID_HANDLE_VALUE) {
		...
		hDriver = CreateFile("\\\\.\\123", GENERIC_ALL, FILE_SHARE_READ | FILE_SHARE_WRITE, 0, OPEN_EXISTING, 0, 0);
...
bool KernelDriver::_startService() {
	...
	// open Service.
	hService = OpenService(hSCManager, "123", SERVICE_ALL_ACCESS);

	if (!hService) {
		hService = 
		CreateService(hSCManager, "123", "123",
